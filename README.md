...
1.  **Clone the Repo / 克隆仓库**:
    ```bash
    git clone https://github.com/Rayinf/liquid-art.git
    cd liquid-art
    ```
...
3.  **Launch the Lab / 启动实验室**:
    ```bash
    npm run dev
    ```

4.  **Configure API Access / 配置 API**:
    Open the app, click the **Settings (Gear Icon)**, and paste your Gemini API Key. / 打开应用，点击右上角**设置（齿轮图标）**，粘贴您的 Gemini API Key。
...
*   **AI Service**: `@google/genai` (Gemini SDK)
*   **Build Tool**: Vite
*   **Simulation**: Custom SVG Logic

---

## 🎨 Aesthetic Guidelines / 视觉规范

Liquid Art follows a strict **Retro-Industrial Pixel** aesthetic: / Liquid Art 遵循严格的**复古工业像素**美学：
...
<div align="center">
  <p><i>"Crafting Digital Soul in Every Pixel." / "在每一个像素中铸就数字灵魂。"</i></p>
  <img src="https://img.shields.io/badge/Powered%20By-Antigravity-purple" alt="Powered By Antigravity" />
</div>
